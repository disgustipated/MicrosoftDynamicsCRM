...
{
  public partial class IFDAuthenticationConfigurationControl : PluginConfigurationPartControl
  {
    ...
    {
      lblServer.Text = LocalizedResourceManager.GetString("DotNetScript", "IFDAuthenticationConfigurationControl.lblServer.Text");
      lblPort.Text = LocalizedResourceManager.GetString("DotNetScript", "IFDAuthenticationConfigurationControl.lblPort.Text");
      lblUserName.Text = LocalizedResourceManager.GetString("DotNetScript", "IFDAuthenticationConfigurationControl.lblUserName.Text");
      lblPassword.Text = LocalizedResourceManager.GetString("DotNetScript", "IFDAuthenticationConfigurationControl.lblPassword.Text");
      lblDomain.Text = LocalizedResourceManager.GetString("DotNetScript", "IFDAuthenticationConfigurationControl.lblDomain.Text");
      chkSecureConnection.Text = LocalizedResourceManager.GetString("DotNetScript", "IFDAuthenticationConfigurationControl.chkSecureConnection.Text");
    ...
    private void loadInitialValues()
    {
      ...
      {
        MessageBox.Show(String.Format(LocalizedResourceManager.GetString("DotNetScript", "IFDAuthenticationConfigurationControl.Error.LoadingConfiguration"), ErrorHelper.GetErrorDescription(exc)), "3CX Microsoft Dynamics CRM Plug-in", MessageBoxButtons.OK, MessageBoxIcon.Error);
      }
      finally
      {
        enableNotifications();
    ...
    public IFDAuthenticationConfigurationControl()
    {
      InitializeComponent();
